...
const faqs = [
  {
    ...
    answer:
      "Simply click the 'Enroll Now' button on the course card you’re interested in, and you will be redirected to our secure in-app enrollment page to fill out your details.",
  },
  {
